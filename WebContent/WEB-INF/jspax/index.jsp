	...
	<div class="main">
		...
		<div class="container_12">
			<div class="grid_12">
				<div class="slider">
					<ul class="items">
						<li><img src="resources/images/slider-1.jpg" alt="">
							<div class="banner">
								<p class="font-1">
						...
						<li><img src="resources/images/slider-2.jpg" alt="">
							<div class="banner">
								<p class="font-1">
						...
						<li><img src="resources/images/slider-3.jpg" alt="">
							<div class="banner">
								<p class="font-1">
				...
				<div class="block-1 box-shadow">
					<p class="font-3">
						Fitness Club is one of <a
							...
							target="_blank" class="color-1">free website templates</a>
						created by TemplateMonster. This website template is optimized for
						1280X1024 screen resolution. This <a
							...
							<div class="wrap box-1 top-2">
								...
								<div class="extra-wrap">
									...
									<p>Hendrerit in vulputate velit esse molestie consequat,
										...
										zzril delenit augue duis dolore te feugait nulla facilis lorem
										ipsum dolor.</p>
								</div>
							</div>
						</div>
